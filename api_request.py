...
def getResultLog(resultId,fileNames):
    #27792787
    lists=[]
    response = requests.get('https://a.blazemeter.com/api/v4/masters/{}'.format(resultId), auth=('962ba9f2b9045301001bf263', 'd4e5d0a1029ddb0e222c2ac6cff053002c3fd281a7a054074dc8f282ae448e381afa4df1'))
    ...
    for sessionID in sessionsIds:
        ...
        response = requests.get('https://a.blazemeter.com/api/v4/sessions/{}/reports/logs'.format(sessionID), auth=('962ba9f2b9045301001bf263', 'd4e5d0a1029ddb0e222c2ac6cff053002c3fd281a7a054074dc8f282ae448e381afa4df1'))
        out2= response.content
